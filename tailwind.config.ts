...
const config: Config = {
  ...
  theme: {
    ...
    fontSize: {
      ...
      'title-s': ['clamp(1.1rem, 0.8vw, 1.5rem)', { lineHeight: '1.4' }],
      'body-l': ['clamp(1.0rem, 0.75vw, 1.25rem)', { lineHeight: '1.7' }],
      'body-m': ['clamp(0.94rem, 0.65vw, 1.2rem)', { lineHeight: '1.7' }],
      'body-s': ['clamp(0.85rem, 0.6vw, 1.0rem)', { lineHeight: '1.7' }],
